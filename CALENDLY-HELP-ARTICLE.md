# Calendly Integration Help Articles

These articles should be added through the Admin → Help interface at /admin/help

---

## Article 1: How to Connect Calendly to Your Email Signatures

**Category:** Integrations  
**Type:** Guide  
**Slug:** connect-calendly-integration  
**Show in Marketing:** Yes  
...
## Article 2: Adding Calendly Links to Email Signatures

**Category:** Integrations  
**Type:** Tutorial  
**Slug:** add-calendly-links-signatures  
**Show in Marketing:** Yes  
**Show in Dashboard:** Yes  
**Sort Order:** 11
...
**Category:** Integrations  
**Type:** Guide  
**Slug:** manage-calendly-event-types  
**Show in Marketing:** No  
**Show in Dashboard:** Yes  
**Sort Order:** 12
...
## Article 4: Troubleshooting Calendly Integration

**Category:** Integrations  
**Type:** FAQ  
**Slug:** troubleshoot-calendly-integration  
**Show in Marketing:** No  
**Show in Dashboard:** Yes  
**Sort Order:** 13
...
## Article 5: Calendly Integration Best Practices

**Category:** Integrations  
**Type:** Guide  
**Slug:** calendly-integration-best-practices  
**Show in Marketing:** Yes  
**Show in Dashboard:** Yes  
**Sort Order:** 14
...
## How to Add These Articles

1. Log in as an admin
2. Go to **/admin/help**
3. Click **New Article** for each article above
4. Copy the content, category, type, and settings
5. Click **Save**
6. Repeat for all 5 articles

These articles will appear in:
- Marketing site at /help (for articles marked "Show in Marketing")
- Dashboard support at /support (for articles marked "Show in Dashboard")
