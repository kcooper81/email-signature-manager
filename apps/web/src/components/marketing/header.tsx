    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-1">
          ...
          <div className="relative group">
            ...
            <div className="absolute top-full left-0 mt-2 w-72 bg-white rounded-xl shadow-xl border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 p-3">
              <Link href="/google-workspace" className="flex items-start gap-3 px-3 py-3 rounded-lg hover:bg-violet-50 group/item transition-colors">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-gray-500">Primary platform &mdash; deploy signatures org-wide</div>
                </div>
              </Link>
              ...
              <Link href="/integrations/microsoft-365" className="flex items-start gap-3 px-3 py-2.5 rounded-lg hover:bg-gray-50 group/item transition-colors">
                <div className="h-10 w-10 rounded-lg bg-blue-50 flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex-1">
                  <div className="text-sm font-medium text-gray-500 mb-0.5">Microsoft 365</div>
                  <div className="text-xs text-gray-400">Also supported</div>
                </div>
              </Link>
            </div>
          </div>
          ...
          <div className="relative group">
            ...
            <div className="absolute top-full left-0 mt-2 w-56 bg-white rounded-xl shadow-xl border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 p-2">
              ...
              <Link href="/partners/apply" className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-gray-50 group/item transition-colors">
                <Users className="h-4 w-4 text-gray-400 group-hover/item:text-violet-600" />
                <span className="text-sm text-gray-700">Partner Program</span>
              </Link>
            </div>
          </div>
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden fixed inset-x-0 top-[57px] bottom-0 bg-white z-50 flex flex-col">
          <div className="flex-1 overflow-y-auto px-4 py-4">
            ...
            <div className="py-4 border-b border-gray-100">
              ...
              <div className="grid grid-cols-2 gap-1">
                <Link href="/for/it-admins" className="flex items-center gap-2 px-3 py-2.5 text-sm text-gray-700 hover:bg-gray-50 rounded-lg" onClick={() => setMobileMenuOpen(false)}>
                  <Wrench className="h-4 w-4 text-violet-500" />
                  IT Admins
                </Link>
                <Link href="/for/marketing" className="flex items-center gap-2 px-3 py-2.5 text-sm text-gray-700 hover:bg-gray-50 rounded-lg" onClick={() => setMobileMenuOpen(false)}>
                  <Zap className="h-4 w-4 text-blue-500" />
                  Marketing
                </Link>
                <Link href="/for/small-business" className="flex items-center gap-2 px-3 py-2.5 text-sm text-gray-700 hover:bg-gray-50 rounded-lg" onClick={() => setMobileMenuOpen(false)}>
                  <Briefcase className="h-4 w-4 text-emerald-500" />
                  Small Biz
                </Link>
                <Link href="/for/enterprise" className="flex items-center gap-2 px-3 py-2.5 text-sm text-gray-700 hover:bg-gray-50 rounded-lg" onClick={() => setMobileMenuOpen(false)}>
            ...
            <div className="py-4 border-b border-gray-100">
              <div className="px-3 pb-2 text-xs font-semibold text-gray-400 uppercase tracking-wider">Integrations</div>
              <div className="space-y-1">
                <Link href="/google-workspace" className="flex items-center gap-3 px-3 py-2.5 text-sm font-medium text-gray-900 hover:bg-violet-50 rounded-lg" onClick={() => setMobileMenuOpen(false)}>
                ...
                <Link href="/integrations/hubspot" className="flex items-center gap-3 px-3 py-2.5 text-sm text-gray-700 hover:bg-gray-50 rounded-lg" onClick={() => setMobileMenuOpen(false)}>
                  <div className="h-6 w-6 rounded bg-orange-50 flex items-center justify-center">
                    <svg className="h-3.5 w-3.5" viewBox="0 0 24 24" fill="#FF7A59">
                      <path d="M18.164 7.93V5.084a2.198 2.198 0 001.267-1.978v-.07A2.199 2.199 0 0017.232.837h-.068a2.199 2.199 0 00-2.199 2.199v.07a2.196 2.196 0 001.267 1.977v2.847a4.301 4.301 0 00-2.066.7L9.77 4.233a2.25 2.25 0 10-1.342 1.342l4.396 4.396a4.3 4.3 0 00-.7 2.066H9.278a2.196 2.196 0 00-1.978-1.267h-.07a2.199 2.199 0 00-2.199 2.199v.068a2.199 2.199 0 002.199 2.199h.07a2.196 2.196 0 001.977-1.267h2.847a4.301 4.301 0 107.04-4.04z"/>
                    </svg>
                  </div>
                  HubSpot CRM
                ...
                <Link href="/integrations/microsoft-365" className="flex items-center gap-3 px-3 py-2.5 text-sm text-gray-400 hover:bg-gray-50 rounded-lg" onClick={() => setMobileMenuOpen(false)}>
                  <div className="h-6 w-6 rounded bg-gray-50 flex items-center justify-center">
                    <svg className="h-3.5 w-3.5" viewBox="0 0 24 24" fill="#0078D4">
                      <path d="M11.5 0h12v12h-12zM0 0h11v11H0zM11.5 12.5h12v11.5h-12zM0 11.5h11V23H0z"/>
                    </svg>
                  </div>
                  Microsoft 365
            ...
            {/* Resources section */}
            <div className="py-4">
              <div className="px-3 pb-2 text-xs font-semibold text-gray-400 uppercase tracking-wider">Resources</div>
              <div className="grid grid-cols-2 gap-1">
                <Link href="/blog" className="flex items-center gap-2 px-3 py-2.5 text-sm text-gray-700 hover:bg-gray-50 rounded-lg" onClick={() => setMobileMenuOpen(false)}>
                  <FileText className="h-4 w-4 text-gray-400" />
                  Blog
                </Link>
                <Link href="/tools/signature-generator" className="flex items-center gap-2 px-3 py-2.5 text-sm text-gray-700 hover:bg-gray-50 rounded-lg" onClick={() => setMobileMenuOpen(false)}>
                ...
                <Link href="/partners/apply" className="flex items-center gap-2 px-3 py-2.5 text-sm text-gray-700 hover:bg-gray-50 rounded-lg" onClick={() => setMobileMenuOpen(false)}>
          ...
          <div className="flex-shrink-0 px-4 py-4 bg-gray-50 border-t border-gray-200 space-y-2">
            <Link href="/login" className="block" onClick={() => setMobileMenuOpen(false)}>
              <Button variant="outline" className="w-full h-11">Sign in</Button>
            </Link>
            <Link href="/signup" className="block" onClick={() => setMobileMenuOpen(false)}>
              <Button className="w-full h-11 bg-gradient-to-r from-violet-600 to-blue-600">Get Started Free</Button>
            </Link>
          </div>
        </div>
      )}
