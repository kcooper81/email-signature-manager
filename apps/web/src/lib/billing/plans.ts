...
export const PLANS: Record<string, Plan> = {
  free: {
    ...
    featureList: [
      ...
      { text: 'Visual signature editor', included: true },
      { text: 'Google Workspace sync', included: true },
  ...
  starter: {
    ...
    featureList: [
      ...
      { text: 'Visual signature editor', included: true },
      { text: 'Google + Microsoft 365 sync', included: true },
      { text: 'One-click deployment', included: true },
  ...
  professional: {
    ...
    featureList: [
      ...
      { text: 'Advanced signature editor', included: true },
      { text: 'Google + Microsoft 365 sync', included: true },
