  ...
  return (
    ...
    <article className="py-12">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold mb-6">Email Signature Brand Guidelines</h1>
        ...
        <Image src="/blog-images/photo-1542744094-3a31f272c490.jpg" alt="Brand guidelines" width={1200} height={600} className="rounded-2xl mb-12" />
        <div className="prose prose-lg max-w-none">
          ...
          <RelatedPosts currentUrl="/blog/email-signature-brand-guidelines" count={3} />
    </>
  );
}
