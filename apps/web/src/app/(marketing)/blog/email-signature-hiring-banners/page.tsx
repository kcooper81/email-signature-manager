  ...
  return (
    ...
    <article className="py-12">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold mb-6">Using Email Signatures for Recruiting & Hiring</h1>
        ...
        <Image src="/blog-images/photo-1521737711867-e3b97375f902.jpg" alt="Hiring team" width={1200} height={600} className="rounded-2xl mb-12" />
        <div className="prose prose-lg max-w-none">
          ...
          <RelatedPosts currentUrl="/blog/email-signature-hiring-banners" count={3} />
    </>
  );
}
