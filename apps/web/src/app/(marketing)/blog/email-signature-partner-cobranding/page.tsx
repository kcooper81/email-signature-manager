...
export default function BlogPost() {
  const blogSchema = generateBlogPostSchema({
    ...
    image: '/blog-images/photo-1521791136064-7986c2920216.jpg',
  ...
  return (
    ...
    <article className="py-12">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold mb-6">Partner Co-Branding in Email Signatures</h1>
        ...
        <Image src="/blog-images/photo-1521791136064-7986c2920216.jpg" alt="Partnership" width={1200} height={600} className="rounded-2xl mb-12" />
        <div className="prose prose-lg max-w-none">
          ...
          <RelatedPosts currentUrl="/blog/email-signature-partner-cobranding" count={3} />
    </>
  );
}
