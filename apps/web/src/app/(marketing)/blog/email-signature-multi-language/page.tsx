...
export default function BlogPost() {
  const blogSchema = generateBlogPostSchema({
    ...
    image: '/blog-images/photo-1526778548025-fa2f459cd5c1.jpg',
  ...
  return (
    ...
    <article className="py-12">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold mb-6">Multi-Language Email Signatures for Global Teams</h1>
        ...
        <Image src="/blog-images/photo-1526778548025-fa2f459cd5c1.jpg" alt="Global team" width={1200} height={600} className="rounded-2xl mb-12" />
        <div className="prose prose-lg max-w-none">
          ...
          <RelatedPosts currentUrl="/blog/email-signature-multi-language" count={3} />
    </>
  );
}
