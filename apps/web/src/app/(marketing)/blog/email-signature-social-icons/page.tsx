...
export default function BlogPost() {
  const blogSchema = generateBlogPostSchema({
    ...
    image: '/blog-images/photo-1611162617474-5b21e879e113.jpg',
  ...
  return (
    ...
    <article className="py-12">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold mb-6">Social Media Icons in Email Signatures: Best Practices</h1>
        ...
        <Image src="/blog-images/photo-1611162617474-5b21e879e113.jpg" alt="Social media icons" width={1200} height={600} className="rounded-2xl mb-12" />
        <div className="prose prose-lg max-w-none">
          ...
          <RelatedPosts currentUrl="/blog/email-signature-social-icons" count={3} />
    </>
  );
}
