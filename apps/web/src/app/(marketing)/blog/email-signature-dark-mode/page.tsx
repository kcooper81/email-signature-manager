  ...
  return (
    ...
    <article className="py-12">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold mb-6">Email Signatures in Dark Mode: Design Tips</h1>
        ...
        <Image src="/blog-images/photo-1555949963-ff9fe0c870eb.jpg" alt="Dark mode" width={1200} height={600} className="rounded-2xl mb-12" />
        <div className="prose prose-lg max-w-none">
          ...
          <RelatedPosts currentUrl="/blog/email-signature-dark-mode" count={3} />
    </>
  );
}
