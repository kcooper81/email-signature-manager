  ...
  return (
    ...
    <article className="py-12">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold mb-6">Professional Services Email Signatures</h1>
        ...
        <Image src="/blog-images/photo-1454165804606-c3d57bc86b40.jpg" alt="Professional services" width={1200} height={600} className="rounded-2xl mb-12" />
        <div className="prose prose-lg max-w-none">
          ...
          <RelatedPosts currentUrl="/blog/email-signature-professional-services" count={3} />
    </>
  );
}
