  ...
  return (
    ...
    <article className="py-12">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold mb-6">Email Signatures with HubSpot CRM Integration</h1>
        ...
        <Image src="/blog-images/photo-1460925895917-afdab827c52f.jpg" alt="CRM integration" width={1200} height={600} className="rounded-2xl mb-12" />
        <div className="prose prose-lg max-w-none">
          ...
          <RelatedPosts currentUrl="/blog/email-signature-hubspot-integration" count={3} />
    </>
  );
}
