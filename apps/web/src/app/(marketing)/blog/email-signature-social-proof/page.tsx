  ...
  return (
    ...
    <article className="py-12">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold mb-6">Adding Social Proof to Email Signatures</h1>
        ...
        <Image src="/blog-images/photo-1553877522-43269d4ea984.jpg" alt="Awards and recognition" width={1200} height={600} className="rounded-2xl mb-12" />
        <div className="prose prose-lg max-w-none">
          ...
          <RelatedPosts currentUrl="/blog/email-signature-social-proof" count={3} />
    </>
  );
}
