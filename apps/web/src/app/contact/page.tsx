              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:sales@siggly.com" className="text-violet-600 text-sm hover:underline">
                      sales@siggly.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@siggly.com" className="text-violet-600 text-sm hover:underline">
                      support@siggly.com
                    </a>
                  </div>
                </div>
